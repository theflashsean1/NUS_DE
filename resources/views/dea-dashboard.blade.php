...
@section('modal')
                       ...
                       if ($i<3){
                           $form = $form.
                                   " <div class='form-group'>
                                        <label for='name-add-".($i+1)."'>".$add_type." Name:(used for search DEA)</label>
                            ...
                            $form = $form." <div class='form-group'>
                                        <label for='name-add-".($i+1)."'>".$add_type.": (used for search DEA)</label>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="edit-DEA">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="form-group" style="float: left">
                        <label for="visibility">Visibility (public)</label>
                        <input type="checkbox" name="visibility"  id="visibility-checkbox">
                    </div>
