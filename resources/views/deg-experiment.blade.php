...
@section('view-de')
    ...
    <table class="table table-hover" id="experiments-table-de">
...
@section('modal')
    ...
    <!--Select DEG Modal-->
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="select-deg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Select DEG</h4>
                </div>
                <section class="select-deg-table">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="edit-Experiment">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" style="color: #000000" href="#" id="DEG-Experiment-image-change">Change Img</button>
                    <button class="btn btn-warning" style="color: #000000" href="#" id="DEG-Experiment-image-delete">Delete Img</button>
